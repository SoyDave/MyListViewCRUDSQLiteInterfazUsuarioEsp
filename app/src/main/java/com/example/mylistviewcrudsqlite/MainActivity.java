...
public class MainActivity extends AppCompatActivity {
    ...
    EditText mEdtTitle, mEdtConsole, mEdtYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEdtConsole = findViewById(R.id.edtConsole);
        mEdtYear = findViewById(R.id.edtYear);
        ...
        mSQLiteHelper.queryData("CREATE TABLE IF NOT EXISTS RECORD (id INTEGER PRIMARY KEY AUTOINCREMENT, title VARCHAR, console VARCHAR, year VARCHAR, image BLOB)");
            ...
            public void onClick(View view) {
                try {
                    mSQLiteHelper.insertData(
                            ...
                            mEdtConsole.getText().toString().trim(),
                            mEdtYear.getText().toString().trim(),
